...
package CRDT.Lww_Element_Sets with SPARK_Mode is
   ...
   function Add_Count (S : LWW_Element_Set) return Natural
   ...
   procedure Add (S : in out LWW_Element_Set; E : Element_Type; TS : Core.Lamport_Time)
   ...
   procedure Remove (S : in out LWW_Element_Set; E : Element_Type; TS : Core.Lamport_Time)
   with Post => Add_Count (S) <= S.Capacity, Depends => (S => (S, E, TS));
   ...
   procedure Merge (Target : in out LWW_Element_Set; Source : LWW_Element_Set)
