   ...
   procedure Run (RunR : in out Runner) is
      ...
      begin
         ...
         begin
            ...
            RunR.Check (CRDT.Pn_Counters.Value (D) = CRDT.Pn_Counters.Value (E), "PN-Counter commutativity: Merge(A,B) = Merge(B,A)");

            D := A;
            CRDT.Pn_Counters.Merge (D, A);
            RunR.Check (CRDT.Pn_Counters.Value (D) = CRDT.Pn_Counters.Value (A), "PN-Counter idempotency: Merge(A,A) = A");
            ...
            RunR.Check (CRDT.Pn_Counters.Value (D) = CRDT.Pn_Counters.Value (E), "PN-Counter associativity: Merge(Merge(A,B),C) = Merge(A,Merge(B,C))");
         end;
         ...
         begin
            ...
            begin
               ...
               RunR.Check (Commute_Ok, "LWW commutativity: Merge(A,B) = Merge(B,A) (semantic)");
            end;
            ...
            begin
               ...
               RunR.Check (Assoc_Ok, "LWW associativity: Merge(Merge(A,B),C) = Merge(A,Merge(B,C)) (semantic)");
            end;
         end;
