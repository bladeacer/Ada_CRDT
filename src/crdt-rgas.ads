...
package CRDT.Rgas with SPARK_Mode is

   package RGA_Pkg is new CRDT.Rga (Element_Type, Max_Items => Max_RGA_Size, Max_Stride => Max_Stride, Max_Replicas => Max_Replicas);
